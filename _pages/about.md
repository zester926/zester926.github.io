...
저는 호기심이 많은편입니다.<br>
좋아하는 것도 많고 하고싶은 것도 너무 많은 나머지, 제 미래를 하나의 길로 이끄는 선택을 그닥 좋아하진 않습니다.
특히 IT 분야에서 직무 선택은 더욱 결정하기 힘든 것 같습니다. 마음 같아서는 ML/DL/프론트/백/펌웨어 모두 하고싶은데 시간은 한정적이니까요.<br>
그중에서도 제가 가장 좋아하는 분야 몇 가지를 꼽자면 다음과 같습니다.
<br>

우선 리눅스 커널 및 ARM Cortex 등 로우레벨 프로그래밍에 관심이 많은데요,
...
## 경력
[**CEEDUP Inc.**](http://ceedup.com) | *2018.11 ~*<br>
...
___
<ul>
	<li>컴퓨터 및 로봇 비전 연구실 학부 연구생</li><br>
	라이다센서 (RP Lidar A2) 스캐닝 제어 구현, ROS 및 SLAM 연구<br>
	<li>애플리케이션 동아리 '앱동'</li><br>
	파이썬 및 C언어 교육 담당. ML/DL 스터디 참여<br>
</ul>

## 자격증/수료증
합격 후기는 자격증 이름을 클릭해주세요
___
